                ...
                <div className="container-fluid">
                    <div className="row">
                        ...
                        <div className="col-xl-7 col-lg-6 icon-boxes d-flex flex-column align-items-stretch justify-content-center py-1 px-lg-5">
                            <h2>Our Solution</h2>
                            <p>
                                D-oil provids an decentralized easy to use ledger that incorporates transparancy and realibility.
                            </p>
                            ...
                            <div className="icon-box">
                                ...
                                <p className="description">The application used IPFS technology for storage of data. Every individual can control who can access their data. Only registerd Organizations and verified individuals can access your data.</p>
                            </div>
                            <div className="icon-box">
                                <div className="icon">
                                ...
                                <p className="description">For an individual to participate in this shared system, it need to be verified by one of the admins. Same goes for the Organizations. They require proper identity license to be succesfully registerd.</p>
                            </div>
                            <div className="icon-box">
                                <div className="icon">
